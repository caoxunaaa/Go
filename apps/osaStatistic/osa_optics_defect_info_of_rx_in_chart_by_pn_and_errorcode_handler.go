...
func GetOsaOpticsDefectInfoOfRxInChartByOsaPnAndErrorCodeHandler(c *gin.Context) {
	...
	res, err := OsaStatisticDisplay.RedisGetOsaOpticsDefectInfoOfRxByPn(osaPn, startTime, endTime)
	if err != nil {
