...
func GetProductionTransmitAutoCoupleDetailInfoByStationIdHandler(c *gin.Context) {
	...
	res, err := ProductionLineStation.GetTransmitAutoCoupleStationDetailInfoByInsName(insname, startTime, endTime)
	if err != nil {
