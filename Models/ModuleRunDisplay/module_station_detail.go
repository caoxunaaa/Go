...
func GetStationStatus(pn, workOrderType, startTime, endTime string) (stationStatusList []StationStatus, err error) {
	//lotType := "TRX正常品"
...
and  b.pn LIKE  '` + pn + `' and /*b.log_action like '&工序' and b.stationid like '&Station%'*/ D.LOT_TYPE LIKE '%` + workOrderType + `%'
